...
1. Push your repo to Heroku: `git push heroku hw06:main`, where `hw06` is the name of your local branch, and `main` is the name of the destination branch on Heroku. 
...
### 2. Accessibility Post-Course Questionnaire 
This quarter, we assigned a few accessibility activities -- to encourage you to think about how people might interact with your applications without mouse or using a screen reader. To reflect on this process, please fill out the Accessibility Questionnaire (Link TBD) if you didn't complete it during Lab 10.

### 3. Accessibility Research Study
...
## What to Turn In
Please review the requirements above and ensure you have met them. When you're done, please submit a zip file that includes:

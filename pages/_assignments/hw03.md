...
<img class="frame xsmall" src="/spring2022/assets/images/homework/hw03/heroku1.png" />
...
1. Push your repo to Heroku: `git push heroku hw03:main`, where `hw03` is the name of your local branch, and `main` is the name of the destination branch on Heroku. Read more on <a href="https://stackoverflow.com/questions/25834500/push-different-branch-to-heroku" target="_blank">StackOverflow</a>.

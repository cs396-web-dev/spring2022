...
Before making any changes to your `photo-app` folder, let's create a new `hw03` branch using git:
...
1. Now type `git branch` and you should see that there are at least 2 branches: `main` and `hw03`. Also note that you are currently on the `hw03` branch (it should be green with an asterik next to it).
1. Push your `hw03` branch to GitHub as follows: `git push -u origin hw03`
1. Open GitHub repo in your web browser and verify that your `hw03` branch is on GitHub.
...
1. Note that your `.gitignore` file is excluding the `.env` file and your virtual environment `env` from your git repository. This is so you don't inadvertently check in your database passwords or third-party python libraries to GitHub.
...
Create a new database called `photo_app`. In my opinion, the easiest way to do this is via the command line:
...
Each time the `populate.py` script is run, it will delete all of the tables and recreate them with some fake data using the SQL Alchemy library. Feel free to take a look at how this script works if you're curious! 
...
<img class="large frame" src="/spring2022/assets/images/homework/hw03/heroku13.png" />

Search for your photoapp in the texbox, and when you find it, click the "connect" button.

<img class="large frame" src="/spring2022/assets/images/homework/hw03/heroku14.png" />
...
<img class="large frame" src="/spring2022/assets/images/homework/hw03/heroku15.png" />

And finally, scroll to the top of the page and click the "Open App" button:

<img class="large frame" src="/spring2022/assets/images/homework/hw03/heroku16.png" />
